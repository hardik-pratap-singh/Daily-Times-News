...
function Navbar({text , settext}) {
    ...
    const [text1 , settext1] = useState("Search Your Topic Here !")
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form className="d-flex" role="search" >
                            <input value={text1} onChange={handleOnChange} className="form-control me-2" type="search" placeholder="Search" aria-label="Search" />
